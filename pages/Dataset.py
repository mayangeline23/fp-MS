...
# Streamlit App
st.markdown("""
    <p style="font-family: 'Times New Roman', serif; font-size: 30px;">
    Health Risk Prediction with Modeling and Simulation
    </p>
    """, unsafe_allow_html=True)
...
# Message with Times New Roman font
else:
    st.markdown("""
    <p style="font-family: 'Times New Roman', serif; font-size: 16px;">
    Please select a dataset from the dropdown to begin.
    </p>
    """, unsafe_allow_html=True)